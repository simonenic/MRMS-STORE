...
mongoose.connect('localhost:27017/mrmsbd')
...
//unione bootstrap
//app.use('/Client/', express.static(path.join(__dirname, '/assets')));
...
app.use('/Client/www', express.static(__dirname + '/Client/www'));
...
*/
//Collegamento alla pagina prodotti.
//var mongoose = require('./db/prodotti.js');
//app.use('/', mongoose);
